...
//       calculate.textContent = `Not correct. You're too high. Attempts left: ${maxAttempts - attempts}`;
//     } else {
//       calculate.textContent = `Not correct. You're too low. Attempts left: ${maxAttempts - attempts}`;
//     }
//   }
//   userInput.value = "";
